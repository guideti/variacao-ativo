...
Widget makePage({required String path, required Widget Function() page}) {
  final getPages = [
    ...
    GetPage(name: '/any_route', page: () => Scaffold(appBar: AppBar(title: const Text('any title')), body: const Text('fake page')))
  ];
  if (path != '/home') {
    getPages.add(GetPage(name: '/home', page: () => const Scaffold(body: Text('fake home'))));
  }
